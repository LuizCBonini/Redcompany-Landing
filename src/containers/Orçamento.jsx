    ...
    return ( 
        ...
        <section className='flex relative'>
            <div className='ml-36 mt-28'>
                ...
                <p className='text-text font-poppins text-lg font-normal max-w-sm'>Com <span className='text-bordo font-bold'>personalização, padronização</span> e <span className='text-bordo font-bold'>móveis exclusivos</span> com design italiano, <span className='text-bordo font-bold'>desenvolvemos, planejamos e executamos</span> o projeto da sua loja física.</p>
            </div>
            ...
            <div className='w-[527px] h-[717px] shadow-orçamento-shadow rounded-2xl mt-20 ml-24 p-10 '>
                ...
                <span>
                    <label htmlFor="Nome" className='text-text font-poppins text-sm font-semibold'>Nome*</label>
                ...
                <div className='grid grid-cols-2 gap-4 mt-5'>
                    <span>
                        <label htmlFor="email" className='text-text font-poppins text-sm font-semibold'>E-mail*</label>
                    ...
                    <span>
                        <label htmlFor="tel" className='text-text font-poppins text-sm font-semibold'>Telefone*</label>
                    ...
                    <span>
                        <label htmlFor="empresa" className='text-text font-poppins text-sm font-semibold mt-5'>Empresa*</label>
                    ...
                    <span>
                        <label htmlFor="site" className='text-text font-poppins text-sm font-semibold mt-5'>Site</label>
                ...
                <span className='flex mt-20 justify-center'><input type="checkbox" name="" id="" /> <p className='text-text font-poppins text-xs font-semibold ml-2'>Li e aceito os <a href="/" className='text-green border-b-2 border-green'>Termos de Uso</a> e <a href="/" className='text-green border-b-2 border-green'>Política de Privacidade</a></p></span>
